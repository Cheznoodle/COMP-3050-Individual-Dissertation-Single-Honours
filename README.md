...
## Overview
**Text-minator** is a free and accessible AI-powered plagiarism detection tool that analyses text using multiple machine learning models, including **GPT-J, DeBERTa, T5, and BERT**. The application runs on **Streamlit**, providing an interactive web-based interface for analysis.
...
- Displays detection results with visualisations.
